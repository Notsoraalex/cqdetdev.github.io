...
const Root: React.FC = () => {
    return (
        <div key="1" className="flex flex-col min-h-[100dvh] bg-gradient-to-br from-gray-950 to-[#1e1e1e] text-gray-50">
            <header className="px-4 lg:px-6 h-14 flex items-center border-b border-gray-800">
                ...
                <nav className="ml-auto flex gap-4 sm:gap-6">
                    <Link className="text-sm font-medium hover:text-red-500" href="#">
                        Home
                    </Link>
                    <Link className="text-sm font-medium hover:text-red-500" href="#projects">
                        Projects
                    </Link>
                    <Link className="text-sm font-medium hover:text-red-500" href="#skills">
                        Skills
                    </Link>
                    <Link className="text-sm font-medium hover:text-red-500" href="#contact">
                        Contact
                    </Link>
                    <Link className="text-sm font-medium hover:text-red-500" href="https://github.com/cqdetdev">
                        Github
                    </Link>
                </nav>
            </header>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    <div className="space-y-4">
                        ...
                        <div className="text-center">
                            <h1 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">cqdetdev</h1>
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-gray-400 leading-relaxed">
                            Hi, I'm cqdetdev. I started programming in 2019 with Discord bots and and moved by way
                            towards Minecraft: Bedrock Edition plugin development. I later found a love for Go and
                            web development (specifically using React). I'm currently learning Rust and working more
                            with React/Go/Typescript to create web apps and other backend resources.
                        </p>
                    </div>
                </div>
            </section>
            <section className="bg-gradient-to-br from-gray-800 to-[#141414] py-12 md:py-24 lg:py-32 flex justify-center items-center" id="projects">
                <div className="container px-4 md:px-6">
                    <div className="space-y-4 text-center">
                        <h2 className="text-2xl font-bold tracking-tight">My Projects</h2>
                        <p className="text-gray-400">Check out some of the (public) projects I've worked on.</p>
                    </div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mt-8">
                        <Card className="bg-gray-800 border border-gray-700 dark:border-gray-800 shadow-gray-900 shadow-xl">
                            <CardHeader>
                                <CardTitle className="text-gray-50">mcbe.dev</CardTitle>
                            </CardHeader>
                            <CardContent>
                                <p className="text-gray-400">A work-in-progress developer-oriented forum using Next.js, Tailwind, and Shadcn.</p>
                            </CardContent>
                            <CardFooter>
                                <Link
                        ...
                        <Card className="bg-gray-800 border  border-gray-700 dark:border-gray-800 shadow-gray-900 shadow-xl">
                            <CardHeader>
                                <CardTitle className="text-gray-50">TedacMC</CardTitle>
                            </CardHeader>
                            <CardContent>
                                <p className="text-gray-400">A proxy written in Go to allow gameplay on legacy Minecraft clients.</p>
                            </CardContent>
                            <CardFooter>
                                <Link
                                    className="inline-flex items-center justify-center rounded-md bg-red-500 px-4 py-2 text-sm font-medium text-gray-50 shadow transition-colors hover:bg-red-600 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-red-950 disabled:pointer-events-none disabled:opacity-50"
                        ...
                        <Card className="bg-gray-800 border border-gray-200 dark:border-gray-800 shadow-gray-900 shadow-xl">
                            <CardHeader>
                                <CardTitle className="text-gray-50">Apollo</CardTitle>
                            </CardHeader>
                            <CardContent>
                                <p className="text-gray-400">A powerful, modular Discord bot written in TypeScript and built with SWC.</p>
                            </CardContent>
                            <CardFooter>
                                <Link
                                    className="inline-flex items-center justify-center rounded-md bg-red-500 px-4 py-2 text-sm font-medium text-gray-50 shadow transition-colors hover:bg-red-600 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-red-950 disabled:pointer-events-none disabled:opacity-50"
            ...
            <section className="py-12 md:py-24 lg:py-32 flex justify-center items-center" id="skills">
                <div className="container px-4 md:px-6">
                    <div className="space-y-4 text-center">
                        <h2 className="text-2xl font-bold tracking-tight">My Skills</h2>
                        <p className="text-gray-400">Here are some of the technologies I'm proficient in.</p>
                    </div>
            ...
            <section className="bg-gradient-to-br from-gray-800 to-[#141414] py-12 md:py-24 lg:py-32 flex justify-center items-center" id="contact">
                <div className="container px-4 md:px-6">
                    <div className="space-y-4 text-center">
                        <h2 className="text-2xl font-bold tracking-tight">Get in Touch</h2>
                        <p className="text-gray-400 animate-fade-in">
                            <Link className="underline" href="https://discord.com/users/522895569039917066">
                                Feel free to reach out to me on Discord for any inquiries, collaboration, or commissions involving MCBE or web-dev.
                            </Link>
                        </p>
                    </div>
            ...
            <footer className="bg-gray-800 py-6 text-center">
                <p className="text-gray-400 text-sm">© 2024 cqdetdev. All rights reserved.</p>
            </footer>
        </div>
    )
}
...
const FolderGitIcon = (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => {
    return (
        <svg
            {...props}
            xmlns="http://www.w3.org/2000/svg"
...
const NodeIcon = (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => {
    return (
        <svg {...props} xmlns="http://www.w3.org/2000/svg" width="2270" height="2500" viewBox="0 0 256 282">
            <title>Node.JS</title>
...
const TypeScriptIcon = (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => {
    return (
        <svg
            {...props}
            xmlns="http://www.w3.org/2000/svg"
            ...
            strokeLinecap="round"
            strokeLinejoin="round"
            viewBox="0 0 400 400" width="2500" height="2500"
        >
...
const GoIcon = (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => {
    return (
        <svg
            {...props}
            xmlns="http://www.w3.org/2000/svg"
            height="959" viewBox="-.1 -1 206.8 78.4" width="2700"
            fill="none"
            stroke="currentColor"
            strokeWidth="5"
            strokeLinecap="round"
...
const ReactIcon = (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => {
    return (
